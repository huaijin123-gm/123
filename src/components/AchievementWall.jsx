      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {achievements.map((achievement, index) => (
            <div
              key={achievement}
              className="reveal-card flex items-center gap-4 rounded-3xl border border-[#ffd6e8] bg-[#fff9fc] p-5 shadow-[0_15px_40px_rgba(206,80,128,0.1)]"
              style={{ animationDelay: `${index * 70}ms` }}
            >
              <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#e94683] text-white shadow-[0_12px_24px_rgba(233,70,131,0.28)]">
